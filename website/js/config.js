/**
 * Ghoulhunters site configuration.
 ...
 */
window.GHOULHUNTERS_CONFIG = {
  site: {
    name: 'Ghoulhunters',
    tagline: 'See it. Snap it. Report it. Don\'t move it.',
    subtitle: 'Community Invasive Species Watch',
    region: 'Brisbane River & south-east Queensland',
    description:
      'Ghoulhunters helps communities learn about invasive species, report safely, and earn spotter rewards for genuine accurate sightings.',
  ...
  reporterRewards: {
    ...
    pageMetaDescription:
      'Earn Ghoulhunters spotter rewards for genuine, accurate invasive species sightings — mugs, jackets, coupons, and more.',
    heading: 'Spotter rewards',
    badge: 'Thank our heroes',
    lead:
      'Real sightings. Real impact. Real thanks.',
    body:
      'Ghoulhunters celebrates people who help with care and honesty. Stay active, report what you really see, and you could earn thank-you gifts from our community program.',
    ...
    note:
      'Always report suspected pests to official biosecurity channels too. Ghoulhunters rewards are extra thank-yous for our community — not a replacement for official reporting.',
  },
  ...
  programs: [
    {
      ...
      watchMetaDescription:
        'Ghoulhunters Gold Clam Watch — community awareness and reporting for Brisbane River biosecurity.',
      doNotMoveWarning:
